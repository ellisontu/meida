...
- (void)initView {
    ...
    CGFloat oriHeight = self.originalImage.size.height * (oriWidth / (self.originalImage ? self.originalImage.size.width : SCR_WIDTH));
...
-(UIImage *)getSubImage{
    ...
    CGFloat scaleRatio = self.latestFrame.size.width / (self.originalImage ? self.originalImage.size.width : SCR_WIDTH);
