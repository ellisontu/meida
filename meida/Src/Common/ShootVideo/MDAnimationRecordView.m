...
@interface MDAnimationRecordView ()<CAAnimationDelegate>
...
@implementation MDAnimationRecordView
...
- (void)addCircleLayer
{
    ...
    self.arcLayer.strokeColor = COLOR_HEX_STR(@"0xb91223").CGColor;
...
- (UIImageView *)topImageView
{
    if(!_topImageView){
        ...
        _topImageView.image = ImageFromBundle(@"record_shootTop");
...
- (UIImageView *)bottomImageView
{
    if(!_bottomImageView){
        ...
        _bottomImageView.image = ImageFromBundle(@"record_shootBottom");
