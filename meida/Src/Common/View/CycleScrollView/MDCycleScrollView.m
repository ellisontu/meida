...
static NSString * MDCollectionViewCellID = @"MDCollectionViewCell";

@interface MDCycleScrollView () <UICollectionViewDataSource, UICollectionViewDelegate>
...
@implementation MDCycleScrollView
...
- (void)initialization
{
    _ControlAliment = ContolAlimentCenter;
    ...
    _ControlStyle = ContolStyleClassic;
...
{
    MDCycleScrollView *cycleScrollView = [[self alloc] initWithFrame:frame];
...
+ (instancetype)cycleScrollViewWithFrame:(CGRect)frame delegate:(id<MDCycleScrollViewDelegate>)delegate placeholderImage:(UIImage *)placeholderImage
{
    MDCycleScrollView *cycleScrollView = [[self alloc] initWithFrame:frame];
...
- (void)setupMainView
{
    ...
    [mainView registerClass:[MDCollectionViewCell class] forCellWithReuseIdentifier:MDCollectionViewCellID];
...
- (void)setDelegate:(id<MDCycleScrollViewDelegate>)delegate
{
    _delegate = delegate;
    ...
    if ([self.delegate respondsToSelector:@selector(customCollectionViewCellClassForCycleScrollView:)] && [self.delegate customCollectionViewCellClassForCycleScrollView:self]) {
        [self.mainView registerClass:[self.delegate customCollectionViewCellClassForCycleScrollView:self] forCellWithReuseIdentifier:MDCollectionViewCellID];
    }
}
...
- (void)setPageControlDotSize:(CGSize)pageControlDotSize
{
    ...
    if ([self.pageControl isKindOfClass:[MDPageControl class]]) {
        MDPageControl *pageContol = (MDPageControl *)_pageControl;
...
- (void)setCurrentPageDotColor:(UIColor *)currentPageDotColor
{
    ...
    if ([self.pageControl isKindOfClass:[MDPageControl class]]) {
        MDPageControl *pageControl = (MDPageControl *)_pageControl;
...
- (void)setCurrentPageDotImage:(UIImage *)currentPageDotImage
{
    ...
    if (self.ControlStyle != ContolStyleAnimated) {
        self.ControlStyle = ContolStyleAnimated;
    }
...
- (void)setControlStyle:(ScrollViewContolStyle)ControlStyle
{
...
- (void)setupPageControl
{
    ...
    switch (self.ControlStyle) {
        case ContolStyleAnimated:
        {
            MDPageControl *pageControl = [[MDPageControl alloc] init];
...
- (void)layoutSubviews
{
    ...
    if (self.ControlAliment == ContolAlimentRight) {
...
{
    MDCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:MDCollectionViewCellID forIndexPath:indexPath];
    ...
    if (!self.onlyDisplayText && [imagePath isKindOfClass:[NSString class]]) {
        if ([imagePath hasPrefix:@"http"]) {
            [cell.imageView imageWithUrlStr:imagePath placeholderImage:self.placeholderImage];
        }
        else {
